...
maxRandomSeed = int(2**52-1)
venvActivatePath = None # path to source or None

send_email = True #False # Whether you want to recieve an email when your jobs are done
user_email = 'fsbroekgaarden@gmail.com' #'your.email.address@your.domain'

#-- Path where the output will go
# Does not have to exist, compas_hpc will attempt to create it
rootOutputDir = '/home/floorb/DATA/black_hole-neutron_star/rapid/Z_0.001'
...
seedsFile = "/home/floorb/git/COMPAS/CompasHPC/masterFolder/allSeeds.txt"

#-- Which cluster to use. Current possible clusters are tsunami, g2, ozstar and local
cluster = 'tsunami'
