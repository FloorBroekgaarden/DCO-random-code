...
#os.path.join(git_directory, 'COMPAS/COMPAS')
    ...
    metallicity = 0.001                    # Solar metallicity Asplund+2010
    ...
    AIS_exploratory_phase =  True #False  # If TRUE COMPAS will run the STROOPWAFEL/Adaptive Importance Sampling algorithm
    ...
    pulsar_birth_magnetic_field_min = 10.0
    ...
    pulsar_magnetic_field_decay_massscale = 0.020
    pulsar_minimum_magnetic_field = 8.0

    evolvePulsars = True
    continueAfter2ndSN = True 
    IncludeWDsinDCOfile = False
    ...
    def booleanChoices(self):
        booleanChoices  =  [self.debugging,
                            ...
                            self.evolvePulsars,
			    self.continueAfter2ndSN,
			    self.IncludeWDsinDCOfile]
