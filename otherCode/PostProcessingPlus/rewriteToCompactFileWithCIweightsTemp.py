...
#     pathToData = '/Volumes/Andromeda/DATA/AllDCO/massTransferEfficiencyFixed_0_25/COMPASOutput.h5'
#     pathToDataWithoutCOMPASname = '/Volumes/Andromeda/DATA/AllDCO/massTransferEfficiencyFixed_0_25/'
#     optimistic=int(0)
#     BPSmodelName = 'H'
#     print()
#     print('-------------------------------------------------------')
...
#     pathToData = '/Volumes/Andromeda/DATA/AllDCO/unstableCaseBB/COMPASOutput.h5'
#     pathToDataWithoutCOMPASname = '/Volumes/Andromeda/DATA/AllDCO/unstableCaseBB/'
#     optimistic=int(0)
#     BPSmodelName = 'E'
#     print()
#     print('-------------------------------------------------------')
