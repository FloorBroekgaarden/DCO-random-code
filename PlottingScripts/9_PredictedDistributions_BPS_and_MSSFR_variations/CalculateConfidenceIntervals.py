...
def calculateConfidenceIntervals(BPSmodelName='A', MSSFRnameslist=MSSFRnameslist, DCOtype='BHNS', whichWeight='det'): 
    ...
    dfCSVname = '/Users/floorbroekgaarden/Projects/BHNS_project/PlottingScripts/9_PredictedDistributions_BPS_and_MSSFR_variations/csvFilesConfidenceIntervals/ConfidenceIntervals_model_' + BPSmodelName + '_' + DCOtype + '.csv' 
...
for DCOtype in ['BHNS','NSNS','BHBH']: #'BHBH', 'BHNS',
	print('---------------------------')
	print('---------------------------')
	print('---------------------------')
