...
#             print('mssfr =',ind_mssfr)
	...
	for iii in range(6):
		...
		df = pd.read_csv('/Users/floorbroekgaarden/Projects/BHNS_project/PlottingScripts/8_PredictedRates_BPS_and_MSSFR_variations/ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + namesEMlist[iii] + '.csv', index_col=0)
		...
		df.to_csv('/Users/floorbroekgaarden/Projects/BHNS_project/PlottingScripts/8_PredictedRates_BPS_and_MSSFR_variations/ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + namesEMlist[iii] + '.csv')
...
#             print('mssfr =',ind_mssfr)
	...
	df = pd.read_csv('ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + stringgg + '.csv', index_col=0)
	namez0 = BPSmodelName + ' intrinsic (z=0) [Gpc^{-3} yr^{-1}]'
	nameObs = BPSmodelName + ' observed (design LVK) [yr^{-1}]'
	...
	df.to_csv('ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + stringgg  + '.csv')
...
#             print('mssfr =',ind_mssfr)
	...
	df = pd.read_csv('/Users/floorbroekgaarden/Projects/BHNS_project/PlottingScripts/8_PredictedRates_BPS_and_MSSFR_variations/ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + stringgg + '.csv', index_col=0)
	namez0 = BPSmodelName + ' intrinsic (z=0) [Gpc^{-3} yr^{-1}]'
	nameObs = BPSmodelName + ' observed (design LVK) [yr^{-1}]'
	...
	df.to_csv('/Users/floorbroekgaarden/Projects/BHNS_project/PlottingScripts/8_PredictedRates_BPS_and_MSSFR_variations/ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + stringgg  + '.csv')
...
#             print('mssfr =',ind_mssfr)
	...
	df.to_csv('/Users/floorbroekgaarden/Projects/BHNS_project/PlottingScripts/8_PredictedRates_BPS_and_MSSFR_variations/ratesCSVfiles/ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + stringgg  + '.csv')
...
if INITIALIZE_EM==True:
	...
	for ind_chi, chi in enumerate([0.0, .5, 'Qin']):
		...
		for ind_Rns, NSradii in enumerate([11.5,13.0]):
			...
			df.to_csv('/Users/floorbroekgaarden/Projects/BHNS_project/PlottingScripts/8_PredictedRates_BPS_and_MSSFR_variations/ratesCSVfiles/rates_MSSFR_Models_'+DCOname+ '_' + stringg + '.csv')
